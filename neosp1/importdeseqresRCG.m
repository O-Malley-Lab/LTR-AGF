function Aresults = importdeseqresRCG(filename, dataLines)
...
opts.VariableNames = ["Transcriptome", "meanExp_RCG", "log2FC_RCG", "Var4", "Var5", "Var6", "FDR_RCG"];
opts.SelectedVariableNames = ["Transcriptome","meanExp_RCG", "log2FC_RCG", "FDR_RCG"];
