...
ltrname = importltrname('ltrsequences_neolan1.txt');
...
ltrclassification = importtesorter('tesorterresults_neolan1.txt');
...
writetable(clusteredltrs_ltrdata,'ltrdata_neolan1.xlsx')

saveas(graph_transcribedltrs, 'transcribedclusters_neolan1.png')
saveas(graph_all_ltrs, 'all_ltrs_clustergraph_neolan1.png')
saveas(gcf, 'piechart_neolan1.png')

saveas(graph_transcribedltrs, 'transcribedclusters_neolan1.svg')
saveas(graph_all_ltrs, 'all_ltrs_clustergraph_neolan1.svg')
%saveas(graph_rpkm_vs_cluster, 'rpkmclustergraph_anasp1.svg')
saveas(gcf, 'piechart_neolan1.svg')

%% function to find percent classified LTRs from TESorter
classvsunclass = classvsunclasspie(ltrclassification, ltrname);

saveas(gcf, 'classvsunclass_neolan1.svg')
saveas(gcf, 'classvsunclass_neolan1.png')