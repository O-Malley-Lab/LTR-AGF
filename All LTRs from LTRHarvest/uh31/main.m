...
ltrname = importltrname('ltrsequences_uh31.txt');

%import LTR data from LTRHarvest
ltrlengths = importltrlength('ltrdata_uh31.txt');

%Import BLAST transcriptome matches
BLASTresults = importdatablast('blastresultsuh31.txt');

%Import clustered LTRs
cdhit = importdatacdhit('cdhitresultsaSaL70_uh31.txt');

%Import LTR classification from TEsorter
ltrclassification = importtesorter('tesorterresults_uh31.txt');
...
writetable(clusteredltrs_ltrdata,'ltrdata_uh31.xlsx')

saveas(graph_transcribedltrs, 'transcribedclusters_uh31.png')
saveas(graph_all_ltrs, 'all_ltrs_clustergraph_uh31.png')
saveas(gcf, 'piechart_uh31.png')

saveas(graph_transcribedltrs, 'transcribedclusters_uh31.svg')
saveas(graph_all_ltrs, 'all_ltrs_clustergraph_uh31.svg')
saveas(gcf, 'piechart_uh31.svg')

%% function to find percent classified LTRs from TESorter
classvsunclass = classvsunclasspie(ltrclassification, ltrname);

saveas(gcf, 'classvsunclass_uh31.svg')
saveas(gcf, 'classvsunclass_uh31.png')