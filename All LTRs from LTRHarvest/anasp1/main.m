...
BLASTresults = importdatablast('70cov90ident_dbltrquerytranscriptome_anasp1.txt');
rpkmresults = importrpkm('70cov90ident_dbltrquerytranscriptome_anasp1.txt');
...
saveas(graphretlength, 'retrolength_anasp1.png')
