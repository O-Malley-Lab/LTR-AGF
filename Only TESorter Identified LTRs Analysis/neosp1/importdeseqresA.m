function Aresults = importdeseqresA(filename, dataLines)
...
opts.VariableNames = ["Transcriptome", "meanExp_A", "log2FC_A", "Var4", "Var5", "Var6", "FDR_A"];
opts.SelectedVariableNames = ["Transcriptome","meanExp_A", "log2FC_A", "FDR_A"];
