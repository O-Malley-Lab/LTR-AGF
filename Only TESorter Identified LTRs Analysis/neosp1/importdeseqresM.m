function Aresults = importdeseqresM(filename, dataLines)
...
opts.VariableNames = ["Transcriptome", "meanExp_M", "log2FC_M", "Var4", "Var5", "Var6", "FDR_M"];
opts.SelectedVariableNames = ["Transcriptome","meanExp_M", "log2FC_M", "FDR_M"];
