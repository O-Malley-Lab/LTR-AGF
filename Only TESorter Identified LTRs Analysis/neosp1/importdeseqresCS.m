function Aresults = importdeseqresCS(filename, dataLines)
...
opts.VariableNames = ["Transcriptome", "meanExp_CS", "log2FC_CS", "Var4", "Var5", "Var6", "FDR_CS"];
opts.SelectedVariableNames = ["Transcriptome","meanExp_CS", "log2FC_CS", "FDR_CS"];
